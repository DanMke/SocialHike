...
const StartActivityDetails: React.FC<StartActivityDetailsProps> = ({onUpdateUser, user, navigation}: StartActivityDetailsProps) => {
      ...
      <KeyboardAvoidingView behavior="height">
        ...
        <View style={{paddingHorizontal: 20, height: '100%'}}>
          ...
          <View style={styles.feedElement}> 
            <MapView style={styles.feedElementMap} ref={map => {mapRef = map}}
...
export default connect(mapStateToProps, mapDispatchToProps)(StartActivityDetails);
